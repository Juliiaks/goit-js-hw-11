...
</li>`).join(" ");document.querySelector(".gallery").insertAdjacentHTML("beforeend",r)}m.refresh();const c=document.querySelector(".form");document.querySelector("button");const l=document.querySelector(".loader");c.addEventListener("submit",y);function y(a){a.preventDefault();const o=document.querySelector("#pictures").value.trim();if(o===""){console.log("empty"),i.show({message:"Sorry, there are no images matching your search query. Please try again!",messageColor:"#fff",position:"topRight",backgroundColor:"#ef4040",progressBar:!1,close:!1,timeout:5e3});return}document.querySelector(".gallery").innerHTML="",l.classList.remove("hide"),d(o).then(t=>{t.hits.length===0&&i.show({message:"Sorry, there are no images matching your search query. Please try again!",messageColor:"#fff",position:"topRight",backgroundColor:"#ef4040",progressBar:!1,close:!1,timeout:5e3}),console.log(t),g(t.hits)}).catch(t=>{console.log("catch",t)}).finally(()=>{c.reset(),l.classList.add("hide")})}
